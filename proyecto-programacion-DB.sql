...
create table empleado (
    ...
    administrador_empleado boolean,
    contraseña_empleado varchar(20),
...
create table DetallePedido (
    ...
    nombre_producto varchar(40),
    Cantidad int,
    constraint DetallePedido_pk primary key (ID_pedido, Linea, nombre_producto),
    CONSTRAINT DetallePedido_FK1 FOREIGN KEY (ID_pedido) REFERENCES pedido(ID_pedido),
    CONSTRAINT DetallePedido_FK2 FOREIGN KEY (nombre_producto) REFERENCES producto(nombre_producto)
);
